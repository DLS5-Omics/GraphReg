...
if prediction == True:
    ...
    if plot_scatter == True:
        for i in range(1, 1 + 10):
            ...
            plt.tight_layout()
            plt.savefig(
                "../figs/Seq-models_e2e/scatter_plots/Seq-GraphReg_e2e_scatterplot_" + cell_line + "_" + str(i) + ".png"
            )
            ...
            plt.tight_layout()
            plt.savefig(
                "../figs/Seq-models_e2e/scatter_plots/Seq-CNN_e2e_scatterplot_" + cell_line + "_" + str(i) + ".png"
            )
...
if logfold == True:
    ...
    if plot_scatter == True:
        for i in range(1, 11):
            ...
            plt.tight_layout()
            plt.savefig(
                "../figs/Seq-models_e2e/scatter_plots/Seq-GraphReg_e2e_scatterplot_LogFC_"
                + cell_line_1
                + "_"
                + cell_line_2
                + "_model_"
            ...
            plt.savefig(
                "../figs/Seq-models_e2e/scatter_plots/Seq-CNN_e2e_scatterplot_LogFC_"
                + cell_line_1
                + "_"
                + cell_line_2
                + "_model_"
