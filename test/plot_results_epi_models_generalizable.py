        ...
        for assay_type_test in assay_type_test_list:
            for fdr_train in ["1", "01", "001"]:
                for fdr_test in ["1", "01", "001"]:
                    df1 = pd.read_csv(
                        data_path
                        + "/results/csv/cage_prediction/cell_to_cell/R_NLL_epi_models_"
                        + cell_line_train
                        + "_"
                        + assay_type_train
                        + "_FDR_"
            ...
            df_sub = df[
                (df["Cell_train"] == cell_line_train)
                & (df["3D_data_train"] == assay_type_train)
                & (df["3D_data_test"] == assay_type_test)
            ]
            ...
            g.fig.savefig(
                "../figs/Epi-models/final/cell_to_cell/boxplot_R_check_3D_and_fdr_"
                + cell_line_train
                + "_"
                + assay_type_train
                + "_to_"
            ...
            g.fig.savefig(
                "../figs/Epi-models/final/cell_to_cell/boxplot_NLL_check_3D_and_fdr_"
                + cell_line_train
                + "_"
                + assay_type_train
                + "_to_"
...
df = pd.read_csv(
    data_path
    + "/results/csv/cage_prediction/cell_to_cell/cage_predictions_epi_models_"
    + cell_line_train
    + "_"
    + assay_type_train
    + "_FDR_"
...
for i in range(50):
    ...
    df_R_NLL = df_R_NLL.append(
        {
            "Cell": cell_line_train + " -> " + cell_line_test,
            "Method": "Epi-GraphReg",
            "Genes": "All",
            "Number of Genes": len(df_sub),
            "3D Data": assay_type_train + " -> " + assay_type_test,
            "FDR": str(qval_dict[fdr_train]) + " -> " + str(qval_dict[fdr_test]),
            "R": r_graphreg_all,
...
plt.tight_layout()
plt.savefig(
    "../figs/Epi-models/final/cell_to_cell/boxplot_R_"
    + cell_line_train
    + "_"
    + assay_type_train
    + "_FDR_"
...
plt.tight_layout()
plt.savefig(
    "../figs/Epi-models/final/cell_to_cell/boxplot_NLL_"
    + cell_line_train
    + "_"
    + assay_type_train
    + "_FDR_"
...
for c in range(len(cell_line_train_list)):
        ...
        for assay_type_test in assay_type_test_list:
            for fdr_train in ["1"]:
                for fdr_test in ["1"]:
                    df = pd.read_csv(
                        data_path
                        + "/results/csv/cage_prediction/cell_to_cell/cage_predictions_epi_models_RPGC_"
                        + cell_line_train
                        + "_"
                        + assay_type_train
                        + "_FDR_"
                    ...
                    ax.set_title(
                        "{} to {} | Mean Delta NLL = {:6.2f}".format(
                            cell_line_train,
                            cell_line_test,
                            df_expressed["delta_nll"].mean(),
                        )
                    )
                    ...
                    plt.tight_layout()
                    plt.savefig(
                        "../figs/Epi-models/final/cell_to_cell/scatterplot/scatterplot_delta_nll_hue_cage_"
                        + cell_line_train
                        + "_"
                        + assay_type_train
                        + "_FDR_"
                    ...
                    ax.set_title(
                        "Epi-CNN | {} to {} | R = {:5.3f} | NLL = {:6.2f}".format(
                            cell_line_train, cell_line_test, r_cnn_ex, nll_cnn_ex_mean
                        )
                    )
                    ...
                    plt.tight_layout()
                    plt.savefig(
                        "../figs/Epi-models/final/cell_to_cell/scatterplot/scatterplot_cage_vs_pred_epi_cnn_"
                        + cell_line_train
                        + "_"
                        + assay_type_train
                        + "_FDR_"
                    ...
                    ax.figure.colorbar(sm, label="log2 (N + 1)")
                    ax.set_title(
                        "Epi-GraphReg | {} to {} | R = {:5.3f} | NLL = {:6.2f}".format(
                            cell_line_train,
                            cell_line_test,
                            r_graphreg_ex,
                            nll_graphreg_ex_mean,
                        )
                    )
                    ax.set_xlabel("log2 (true + 1)")
                    ax.set_ylabel("log2 (pred + 1)")
                    plt.tight_layout()
                    plt.savefig(
                        "../figs/Epi-models/final/cell_to_cell/scatterplot/scatterplot_cage_vs_pred_epi_graphreg_"
                        + cell_line_train
                        + "_"
                        + assay_type_train
                        + "_FDR_"
    ...
    g.fig.savefig(
        "../figs/Epi-models/final/cell_to_cell/swarmplot_R_"
        + cell_line_train
        + "_to_"
        + cell_line_test
        + "_check_3D_RPGC.pdf",
    ...
    g.set_xticklabels(labels, rotation=45)
    g.fig.savefig(
        "../figs/Epi-models/final/cell_to_cell/swarmplot_NLL_"
        + cell_line_train
        + "_to_"
        + cell_line_test
        + "_check_3D_RPGC.pdf",
    ...
    g = sns.catplot(
        ...
        kind="bar",  # palette={0.1: "blue", 0.01: "blue", 0.001: "blue"},
        height=3,
        aspect=2,
        sharey=True,
    )
    ...
    g.set_xticklabels(labels, rotation=45)
    g.fig.savefig(
        "../figs/Epi-models/final/cell_to_cell/swarmplot_n_genes_"
        + cell_line_train
        + "_to_"
        + cell_line_test
        + "_RPGC.pdf",
...
g.set_xticklabels(labels, rotation=45)
g.fig.savefig(
    "../figs/Epi-models/final/cell_to_cell/swarmplot_R_only_graphreg_check_3D_RPGC.pdf",
    bbox_inches="tight",
)
g.fig.clf()
...
g.set_xticklabels(labels, rotation=45)
g.fig.savefig(
    "../figs/Epi-models/final/cell_to_cell/swarmplot_NLL_only_graphreg_check_3D_RPGC.pdf",
    bbox_inches="tight",
)
g.fig.clf()
