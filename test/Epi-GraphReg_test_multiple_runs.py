...
if prediction == True:
    ...
    for i in range(1, 1 + 10):
        ...
        if load_np == True:
            ...
            y_hat_gene_cnn = np.load(
                data_path + "/results/numpy/cage_prediction/Epi-CNN_predicted_cage_" + cell_line + "_" + str(i) + ".npy"
            )
            n_contacts = np.load(
    ...
    if plot_scatter == True:
        for i in range(1, 1 + 10):
            ...
            plt.tight_layout()
            plt.savefig(
                "../figs/Epi-models/scatter_plots/Epi-GraphReg_scatterplot_" + cell_line + "_" + str(i) + ".png"
            )
...
if logfold == True:
    ...
    for i in range(1, 1 + 10):
        ...
        if load_np == True:
            ...
            gene_names = np.load(
                data_path + "/results/numpy/cage_prediction/gene_names_" + cell_line_1 + "_" + str(i) + ".npy"
            )
            gene_tss = np.load(
                data_path + "/results/numpy/cage_prediction/gene_tss_" + cell_line_1 + "_" + str(i) + ".npy"
            )
            gene_chr = np.load(
                data_path + "/results/numpy/cage_prediction/gene_chr_" + cell_line_1 + "_" + str(i) + ".npy"
            )
        else:
            model_name_gat = (
                data_path
        ...
        if load_np == True:
            ...
            gene_names = np.load(
                data_path + "/results/numpy/cage_prediction/gene_names_" + cell_line_2 + "_" + str(i) + ".npy"
            )
            gene_tss = np.load(
                data_path + "/results/numpy/cage_prediction/gene_tss_" + cell_line_2 + "_" + str(i) + ".npy"
            )
            gene_chr = np.load(
                data_path + "/results/numpy/cage_prediction/gene_chr_" + cell_line_2 + "_" + str(i) + ".npy"
            )
        else:
            model_name_gat = (
                data_path
    ...
    if plot_scatter == True:
        for i in range(1, 11):
            ...
            # plt.show()
            plt.savefig(
                "../figs/Epi-models/scatter_plots/Epi-GraphReg_scatterplot_LogFC_"
                + cell_line_1
                + "_"
                + cell_line_2
                + "_model_"
            ...
            plt.tight_layout()
            plt.savefig(
                "../figs/Epi-models/scatter_plots/Epi-CNN_scatterplot_LogFC_"
                + cell_line_1
                + "_"
                + cell_line_2
                + "_model_"
