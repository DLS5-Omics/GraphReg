...
if prediction == True:
    ...
    df_all_predictions.to_csv(
        data_path
        + "/results/csv/cage_prediction/epi_models/cage_predictions_epi_models_distal_reg_"
        + cell_line
        + "_"
        + assay_type
        + "_FDR_"
    ...
    if save_R_NLL_to_csv:
        ...
        df.to_csv(
            data_path
            + "/results/csv/cage_prediction/epi_models/R_NLL_epi_models_distal_reg_"
            + cell_line
            + "_"
            + assay_type
            + "_FDR_"
    ...
    for i in range(1, 1 + 64):
        ...
        plt.tight_layout()
        plt.savefig(
            "../figs/distal_reg/scatterplots/scatterplot_"
            + cell_line
            + "_"
            + assay_type
            + "_FDR_"
