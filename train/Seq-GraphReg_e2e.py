...
def main():
    ...
    parser.add_option("-n", dest="n_gat_layers", default=3, type="int")
    ...
    if re_load:
        ...
        model_gat = Model(
            inputs=[X_in, A_in],
            outputs=[mu_cage, mu_h3k4me3, mu_h3k27ac, mu_dnase, h, att],
        )
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch % 1 == 0:
            (
                ...
                valid_rho_h3k27ac,
                valid_rho_dnase,
            ) = calculate_loss(model_gat, valid_chr_list, cell_lines, batch_size, alpha)
        ...
        if valid_loss_cage < best_loss:
            ...
            (
                ...
                test_rho_h3k27ac,
                test_rho_dnase,
            ) = calculate_loss(model_gat, test_chr_list, cell_lines, batch_size, alpha)
            print(
                "test epoch: ",
                epoch,
                ", total loss: ",
