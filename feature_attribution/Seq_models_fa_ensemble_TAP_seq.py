                        ...
                        if (
                            ...
                            if write_bw == True:
                                bw_tap_seq = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/tap_seq_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bw",
                                ...
                                bw_GraphReg = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/Seq-GraphReg_tap_seq_"
                                    + saliency_method
                                    + "_"
                                    + cell_line
                                    + "_"
                                ...
                                bw_CNN = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/Seq-CNN_tap_seq_"
                                    + saliency_method
                                    + "_"
                                    + cell_line
                                    + "_"
                                ...
                                with open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/candidates_tap_seq_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bed",
