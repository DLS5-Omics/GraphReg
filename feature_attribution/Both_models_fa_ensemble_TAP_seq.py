                ...
                if data_exist:
                    if tf.reduce_sum(tf.gather(tss_idx, idx)) > 0:
                        if (
                            ...
                            d = np.minimum(
                                np.abs(cut_tap_seq["Gene.TSS"] - cut_tap_seq["start"]),
                                np.abs(cut_tap_seq["Gene.TSS"] - cut_tap_seq["end"]),
                            ).values
                            ...
                            shap_values_e_cnn = np.load(
                                data_path
                                + "/results/numpy/feature_attribution/Epi-CNN_tap_seq_"
                                + saliency_method
                                + "_"
                                + cell_line
                                + "_"
                            ...
                            if len(Y_true) >= 10 and len(idx_sig) >= n_enh:
                                ...
                                sp_e_cnn_deepshap = np.append(
                                    sp_e_cnn_deepshap,
                                    spearmanr(cnn_fa_gene, logFC_tap_seq)[0],
                                )
                            ...
                            grads_cnn = np.load(
                                data_path
                                + "/results/numpy/feature_attribution/Seq-CNN_tap_seq_"
                                + saliency_method
                                + "_"
                                + cell_line
                                + "_"
                            ...
                            shap_values_e_graphreg = np.load(
                                data_path
                                + "/results/numpy/feature_attribution/Epi-GraphReg_tap_seq_"
                                + saliency_method
                                + "_"
                                + cell_line
                                + "_"
                            ...
                            if len(Y_true) >= 10 and len(idx_sig) >= n_enh:
                                ...
                                sp_e_graphreg_deepshap = np.append(
                                    ...
                                    spearmanr(graphreg_fa_gene, logFC_tap_seq)[0],
                                )
                            ...
                            shap_values_s_graphreg = np.load(
                                data_path
                                + "/results/numpy/feature_attribution/Seq-GraphReg_tap_seq_"
                                + saliency_method
                                + "_"
                                + cell_line
                                + "_"
...
plt.scatter(abc_all[idx_0], logFC_tap_seq_all[idx_0], color="grey", s=80, alpha=0.5)
plt.scatter(abc_all[idx_2], logFC_tap_seq_all[idx_2], color="blue", s=80, alpha=0.5)
plt.scatter(abc_all[idx_1], logFC_tap_seq_all[idx_1], color="red", s=80, alpha=0.5)
...
plt.text(
    2e-6,
    -1.5,
    r"$\rho$ = " + str(spearmanr(abc_all[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16)) + " (Decrease)",
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(e_graphreg_fa_all_deepshap[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(e_graphreg_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(s_graphreg_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
plt.scatter(e_cnn_fa_all_deepshap[idx_1], logFC_tap_seq_all[idx_1], color="red", s=80, alpha=0.5)
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(e_cnn_fa_all_deepshap[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
plt.scatter(e_cnn_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1], color="red", s=80, alpha=0.5)
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(e_cnn_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
plt.scatter(s_cnn_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1], color="red", s=80, alpha=0.5)
...
plt.text(
    ...
    -1.5,
    r"$\rho$ = "
    + str(spearmanr(s_cnn_fa_all_saliency[idx_1], logFC_tap_seq_all[idx_1])[0].astype(np.float16))
    + " (Decrease)",
    horizontalalignment="left",
    verticalalignment="top",
    bbox=props,
...
print(
    ...
    spearmanr(e_graphreg_fa_all_deepshap[idx], logFC_tap_seq_all[idx])[0],
)
print(
    "Epi-GraphReg (saliency) SP for significants: ",
    spearmanr(e_graphreg_fa_all_saliency[idx], logFC_tap_seq_all[idx])[0],
)
print(
    "Seq-GraphReg (saliency) SP for significants: ",
    spearmanr(s_graphreg_fa_all_saliency[idx], logFC_tap_seq_all[idx])[0],
)
print(
    "Epi-CNN (deepshap) SP for significants: ",
    spearmanr(e_cnn_fa_all_deepshap[idx], logFC_tap_seq_all[idx])[0],
)
print(
    "Epi-CNN (saliency) SP for significants: ",
    spearmanr(e_cnn_fa_all_saliency[idx], logFC_tap_seq_all[idx])[0],
)
print(
    "Seq-CNN (saliency) SP for significants: ",
    spearmanr(s_cnn_fa_all_saliency[idx], logFC_tap_seq_all[idx])[0],
)
