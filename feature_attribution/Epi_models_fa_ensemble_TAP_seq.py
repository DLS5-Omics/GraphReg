                ...
                if data_exist:
                    if tf.reduce_sum(tf.gather(tss_idx, idx)) > 0:
                        if (
                            ...
                            if write_bw == True:
                                bw_tap_seq = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Epi-models/tap_seq_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bw",
                                ...
                                bw_GraphReg = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Epi-models/Epi-GraphReg_tap_seq_"
                                    + saliency_method
                                    + "_"
                                    + cell_line
                                    + "_"
                                ...
                                bw_CNN = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Epi-models/Epi-CNN_tap_seq_"
                                    + saliency_method
                                    + "_"
                                    + cell_line
                                    + "_"
                                ...
                                bw_abc.addEntries(chroms, starts, ends=ends, values=abc_vec[idx_pos])
                                bw_GraphReg.addEntries(
                                    chroms,
                                    starts,
                                    ends=ends,
                                    values=scores_gat.ravel()[idx_pos],
                                )
                                bw_CNN.addEntries(
                                    chroms,
                                    starts,
                                    ends=ends,
                                    values=scores_cnn.ravel()[idx_pos],
                                )
                                ...
                                with open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Epi-models/candidates_tap_seq_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bed",
                                    ...
                                    for s_idx, e_idx in zip(start_tap_seq, end_tap_seq):
                                        ...
                                        line = (
                                            ...
                                            + str(e_idx)
                                            + "\t"
                                            + str(significant_tap_seq_bool[cnt])
                                        )
                                        bed_file.write(line)
                                        bed_file.write("\n")
