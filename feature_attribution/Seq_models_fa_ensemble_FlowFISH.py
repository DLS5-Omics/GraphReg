                        ...
                        if (
                            ...
                            if saliency_method == "saliency":
                                ...
                                if len(Y_true) >= 10 and len(idx_sig) >= 1:
                                    ...
                                    print(
                                        "Seq-GraphReg AP score: ",
                                        average_precision_score(Y_true, Y_pred_gat),
                                    )
                                    print(
                                        "Seq-GraphReg AUPRC score: ",
                            ...
                            if write_bw == True:
                                bw_flowfish = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/flowfish_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bw",
                                ...
                                bw_abc = pyBigWig.open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/abc_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bw",
                                ...
                                with open(
                                    data_path
                                    + "/results/bigwig/feature_attribution/Seq-models/candidates_"
                                    + cell_line
                                    + "_"
                                    + gene_names_list[i]
                                    + ".bed",
...
ax.violinplot(SP_list, showmeans=True)
ax.set_title("distribution of " + str(len(sp_abc)) + " genes")
ax.set_ylabel("AUC_PR")
ax.set_xticklabels(["ABC", "Seq-GraphReg"])
ax.grid()
...
print("Seq-GraphReg AP score: ", average_precision_gat)
print("Seq-GraphReg AUPRC score: ", auprc_gat_all)
...
print("Seq-CNN AP score: ", average_precision_cnn)
print("Seq-CNN AUPRC score: ", auprc_cnn_all)
...
plt.plot(
    ...
    precision_gat,
    color="red",
    label="Seq-GraphReg: AUC = " + str(auprc_gat_all.astype(np.float16)),
)
plt.plot(
    recall_cnn,
    precision_cnn,
    color="green",
    label="Seq-CNN: AUC = " + str(auprc_cnn_all.astype(np.float16)),
)
plt.plot(
    recall_abc,
    precision_abc,
...
print(
    "Seq-GraphReg SP for significants: ",
    spearmanr(gat_fa_all[idx], expr_change_percent_all[idx])[0],
)
print(
    "Seq-CNN SP for significants: ",
