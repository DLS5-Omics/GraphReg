...
def main():
    ...
    parser.add_option("-g", dest="genome_index", default=None, type="int", help="Genome index")
    parser.add_option(
        "-s",
        dest="start_i",
        default=0,
    ...
    for chr_temp in chr_list:
        ...
        tfr_file = (
            data_path
            + "/data/tfrecords/distal_reg_paper/tfr_"
            + model
            + "_RPGC_"
            + cell_line
            + "_"
        ...
        seqs_cov_files = [
            data_path + "/data/" + cell_line + "/seqs_cov/distal_reg_paper/CAGE_cov_RPGC_" + chr_temp + ".h5",
        ...
        tss_bin_file = (
            data_path + "/data/tss/" + organism + "/distal_reg_paper/" + genome + "/tss_bins_" + chr_temp + ".npy"
        )
        ...
        bin_start_file = (
            data_path + "/data/tss/" + organism + "/distal_reg_paper/" + genome + "/bin_start_" + chr_temp + ".npy"
        )
        ...
        with tf.io.TFRecordWriter(tfr_file, tf_opts) as writer:
            ...
            print("check symmetric: ", check_symmetric(adj))
