...
for i in range(2, 22):
    ...
    if i in [2, 12]:
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_1/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_1/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_2/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_2/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_3/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_3/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_4/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_4/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_5/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_5/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_6/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_6/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_7/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_7/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_8/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_8/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_9/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_9/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
        ...
        basenji_preds = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_10/bedgraph/preds_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_preds = basenji_preds.sort_values(by=["chr", "start"]).reset_index(drop=True)
        basenji_true = pd.read_csv(
            "/home/labuser/Codes/basenji/output/" + cell_line + "/predictions_bedgraph_10/bedgraph/targets_t0.bedgraph",
            names=["chr", "start", "end", "value"],
            sep="\t",
        )
        basenji_true = basenji_true.sort_values(by=["chr", "start"]).reset_index(drop=True)
    ...
    for pos, g, n in zip(tss_pos, gene_names_all, n_tss):
        ...
        df_start = basenji_preds[
            (basenji_preds["chr"] == "chr" + str(i)) & (np.abs(basenji_preds["start"] - bin_start_5k) <= 64)
        ]
        df_end = basenji_preds[
            (basenji_preds["chr"] == "chr" + str(i)) & (np.abs(basenji_preds["end"] - bin_end_5k) <= 64)
        ]
...
df_basenji_preds_5k = pd.read_csv(
    data_path + "/results/csv/cage_prediction/seq_models/cage_predictions_basenji_" + cell_line + ".csv",
    sep="\t",
)
...
for i in range(len(df_basenji_preds_5k)):
    df_tmp = df_graphreg[
        (df_graphreg["genes"] == df_basenji_preds_5k.loc[i, "genes"])
        & (df_graphreg["tss"] == df_basenji_preds_5k.loc[i, "tss"])
    ]
...
df_basenji_preds_5k = df_basenji_preds_5k.reindex(
    columns=[
        "chr",
        "genes",
        "n_tss",
